        ...
        <div className="flex flex-col h-screen">
            ...
            <main className="flex flex-1">
                <section className="flex flex-1 flex-col pl-32 pr-14 justify-center items-left">
                    ...
                    <button className="text-white w-24 bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none">사용하기</button>
                </section>
